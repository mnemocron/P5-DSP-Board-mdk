  ...
  static float32_t txLeft[DSP_BUFFERSIZE_HALF], txRight[DSP_BUFFERSIZE_HALF];
	...
	*/
	for (index1 = 0; index1 < DSP_BUFFERSIZE_HALF; index1++) {
		rxLeft[index1] = (int16_t)( sourceBuffer[2*index1] );  // (uint16_t)(txLeft[index1]);  //(uint16_t)(txLeft[index1] + ((float32_t)UINT16_MAX/2.0f));
		rxRight[index1] = (int16_t)(sourceBuffer[2*index1+1]);  //(uint16_t)(txRight[index1] + ((float32_t)UINT16_MAX/2.0f));
	}
	...
	*/
	for (index1 = 0; index1 < DSP_BUFFERSIZE_HALF; index1++) {
		targetBuffer[2*index1] = (int16_t)(txLeft[index1] );  // (uint16_t)(txLeft[index1]);  //(uint16_t)(txLeft[index1] + ((float32_t)UINT16_MAX/2.0f));
		targetBuffer[2*index1 + 1] = (int16_t)(txRight[index1]);  //(uint16_t)(txRight[index1] + ((float32_t)UINT16_MAX/2.0f));
	}
